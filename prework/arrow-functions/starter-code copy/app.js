...
// 1. What is "this" when joe.scope() is invoked? refer to the object that have been created which is joe
//    
// 2. What is "this" when joe.scopeArrow() is invoked?  it refere to the windows object instead of the object that it calls it 
//
// 3. Explain why "this" is different when an arrow function is used. because the arrow function is always an anonymouse function and cant be used with object 
//
